    ...
    <BaseModal v-model="showAvatarModal" title="Change Avatar">
      ...
      <template #footer>
        <div class="modal-actions">
          ...
          <BaseButton variant="secondary" :disabled="!selectedAvatar || isUpdatingAvatar" :loading="isUpdatingAvatar"
            @click="updateAvatar">
            Save
          </BaseButton>
        </div>
    ...
    <BaseModal v-model="showAchievementModal" :title="selectedAchievement?.name || 'Achievement'">
      <div class="achievement-details-modal">
        ...
        <div class="achievement-details-content">
          ...
          <div class="achievement-date" v-if="selectedAchievement && isAchievementUnlocked(selectedAchievement.id)">
